...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/src/UpsellItem.tsx
  var import_react19 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  function UpsellItem({ variantId }) {
    var _a, _b, _c, _d;
    const { query } = useApi();
    const [variantData, setVariantData] = (0, import_react19.useState)(null);
    const [isSelected, setIsSelected] = (0, import_react19.useState)(false);
    const hasPageBeenRendered = (0, import_react19.useRef)(false);
    ...
    (0, import_react19.useEffect)(() => {
      ...
      if (hasPageBeenRendered.current) {
        if (isSelected) {
          ...
          const cartLineId = (_a2 = cartLines.find((cartLine) => cartLine.merchandise.id === variantId)) == null ? void 0 : _a2.id;
          if (cartLineId) {
            applyCartLinesChange({
              type: "removeCartLine",
              id: cartLineId,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Pressable2, { onPress: () => setIsSelected(!isSelected), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        InlineLayout2,
        {
          ...
          padding: ["base", "none"],
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: isSelected }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Image2,
              {
                source: ((_a = variantData.image) == null ? void 0 : _a.url) || ((_b = variantData.product.featuredImage) == null ? void 0 : _b.url),
                accessibilityDescription: ((_c = variantData.image) == null ? void 0 : _c.altText) || ((_d = variantData.product.featuredImage) == null ? void 0 : _d.altText),
                border: "base",
                borderRadius: "base",
                borderWidth: "base"
              }
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
                ...
                " ",
                variantData.title === "Default Title" ? "" : " - " + variantData.title
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
  ...
  function Extension() {
    ...
    if (ifMultiple && !collectionData)
      return null;
    if (!ifMultiple && !variantId)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      ...
      !ifMultiple && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(UpsellItem, { variantId })
    ] });
  }
})();
